...
public class TakingTurnsQueueTests
{
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The defect test lies in a misinterpretation of what a "zero" turn count should
    // mean and how the TakingTurnsQueue class likely handles it.
    ...
    // Defect(s) Found: The defect stem from how it interprets negative turn counts
    // and how the TakingTurnsQueue class likely handles them.
